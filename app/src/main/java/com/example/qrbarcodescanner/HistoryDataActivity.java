    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                if (encodeDatatype.equals("TEXT")||encodeDatatype.equals("ISBN")||encodeDatatype.equals("Product")||encodeDatatype.equals("WIFI")||encodeDatatype.equals("GEO")||encodeDatatype.equals("Calendar Event")||encodeDatatype.equals("Driver License")) {
                    ...
                    if(checkPermission(Manifest.permission.CALL_PHONE)) {
                        ...
                        Toast.makeText(HistoryDataActivity.this, "Permission Call Phone denied", Toast.LENGTH_SHORT).show();
                        ActivityCompat.requestPermissions(HistoryDataActivity.this, new String[]{Manifest.permission.CALL_PHONE}, MAKE_CALL_PERMISSION_REQUEST_CODE);
                    }
                }
                else if(encodeDatatype.equals("Contact Information")){
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ActivityCompat.checkSelfPermission(HistoryDataActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(HistoryDataActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    saveData(encodeDatatype,encodeData);
                  /*  Toast.makeText(getApplicationContext(), "Data Saved", Toast.LENGTH_SHORT)
                    ...
                    ActivityCompat.requestPermissions(HistoryDataActivity.this, new
    ...
    private void saveData(String sType, String sBody){
        ...
        try {
            ...
            if (fileDir.exists()) {
                ...
                fos.close();
                Toast.makeText(getApplicationContext(), "Text Saved", Toast.LENGTH_SHORT)
                        .show();
